        ...
        >
          <Tabs defaultValue="content" className="h-full flex flex-col">
            <TabsList className="grid bg-[#1c1d1f] w-full grid-cols-2 p-0 h-14 ">
              <TabsTrigger
                value="content"
                className="data-[state=active]:bg-[#dedede] data-[state=active]:text-black text-white bg-[#1c1d1f] rounded-none h-full transition-colors duration-200 cursor-pointer"
              >
                Course Content
              </TabsTrigger>
              <TabsTrigger
